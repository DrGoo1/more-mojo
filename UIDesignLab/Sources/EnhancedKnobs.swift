...
/// Enhanced 3D knob with psychedelic colored edge glow and embossed "MORE MOJO" text
struct MojoWheelKnob: View {
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            ZStack {
                ...
                ColorArc(startAngle: .degrees(135), endAngle: .degrees(135 + 270 * value), clockwise: true)
                    .stroke(
        ...
        .overlay(
            // Label below the knob if provided
            Group {
                if !label.isEmpty {
...
// Custom ColorArc shape to create partial circle for color indicator
struct ColorArc: Shape {
